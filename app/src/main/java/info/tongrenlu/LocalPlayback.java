...
public class LocalPlayback implements Playback,
    ...
    public LocalPlayback(MusicService service) {
        ...
        this.mWifiLock = ((WifiManager) service.getSystemService(Context.WIFI_SERVICE)).createWifiLock(
    ...
    public void play(Uri dataUri) {
        ...
        if (mCurrentMediaUri == null || !mCurrentMediaUri.equals(dataUri)) {
            mCurrentPosition = 0;
            mCurrentMediaUri = dataUri;
        ...
        if (mState == PlaybackStateCompat.STATE_PAUSED &&
            ...
            mDuration = 0;
                ...
                mMediaPlayer.setDataSource(mService, dataUri);
